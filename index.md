...
* 海外の出演者は出演者の住んでいるところにRTMPサーバを立てる
  * 海外リージョンと国内リージョンの仮想ネットワークはVNetピアリングで結ぶ
  * 仮にドイツリージョンにサーバ立ててテストしたところRTMPの疎通に成功
* 配信先はいったんTwitchを想定
...
Vnetピアリングの費用と海外のRTMPサーバの費用は含みません。
